package com.git.hitzaki.os.service.impl;
...
import com.git.hitzaki.os.mapper.MediaFilesMapper;
import com.git.hitzaki.os.mapper.MediaProcessMapper;
...
//    }
     ...
     * @param bucket
     * @param objectName
     * @return com.git.hitzaki.os.model.po.MediaFiles
     * @description 将文件信息入库
     * @author hitzaki
     */
    @Transactional
    ...
    public RestResponse mergechunks(String fileMd5, int chunkTotal, UploadFileParamsDto uploadFileParamsDto) {
        ...
        try {
            try {
                ...
                BizCenterException.cast("创建临时合并文件出错");
            }
            ...
            try( RandomAccessFile raf_write  =new RandomAccessFile(tempMergeFile, "rw")) {
                ...
                BizCenterException.cast("合并文件过程出错");
            }
    ...
    public MediaFiles getFileById(String id) {
        ...
        if(mediaFiles==null){
            BizCenterException.cast("文件不存在");
        }
        String url = mediaFiles.getUrl();
        if(StringUtils.isEmpty(url)){
            BizCenterException.cast("文件还没有处理，请稍后预览");
        }
    ...
    */
    private File[] checkChunkStatus(String fileMd5,int chunkTotal ){
        ...
        for (int i = 0; i < chunkTotal; i++) {
            ...
            try {
                ...
                e.printStackTrace();
                BizCenterException.cast("创建分块临时文件出错"+e.getMessage());
            }
    ...
    public File downloadFileFromMinIO(File file,String bucket,String objectName){
        ...
        try(
            ...
            e.printStackTrace();
            BizCenterException.cast("查询分块文件出错");
        }
        return null;
    }
    ...
    public void addMediaFilesToMinIO(String filePath, String bucket, String objectName){
        try {
           ...
           BizCenterException.cast("文件上传到文件系统失败");
        }
    }
    //将文件上传到分布式文件系统
    private void addMediaFilesToMinIO(byte[] bytes, String bucket, String objectName) {
        ...
        try {
            ...
            BizCenterException.cast("上传文件到文件系统出错");
        }
    }
